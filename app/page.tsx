      ...
      <section className="pt-32 relative">
        <div className="container grid gap-16 space-y-10 sm:space-y-0 lg:grid-cols-2 lg:items-end">
          ...
          <div className="max-w-xl md:max-w-2xl lg:max-w-none my-auto pb-10">
            <p className="substitle">Smile with Confidence</p>
            ...
            <p className="py-[14px_32px]">
              Lorem ipsum dolor sit amet consectetur. Consequat pharetra ultrices scelerisque arcu lorem augue. Lacus justo euismod justo amet dictum vel sapien est. Imperdiet tempor.
            </p>

            {/* Wrapper */}
            <div className="flex flex-col md:flex-row gap-4">
              <Link href={'/about'} className="primary-btn">LEARN MORE</Link>
              <Link href={'/services'} className="secondary-btn">BROWSE SERVIVES</Link>
            </div>
          </div>
          {/* Image */}
          <div className="relative max-w-max lg:mx-0 lg:ml-auto">
            <Image src={'/images/hero-img.png'} alt="hero image" width={727} height={787} className="relative z-20" />
            <Image src={'/images/hero-card.png'} alt="hero card" width={229} height={109} className="absolute top-11 left-5 z-10 ring ring-primary-200 rounded-lg" />
          </div>
        </div>

        {/* Bg clr */}
        <div className="bg-primary-100 absolute bottom-0 right-0 h-5/12 w-3/4 sm:h-1/2 lg:w-1/2 lg:h-full round-tl-xl lg:rounded-tl-none -z-10" />

        {/* Shape */}
        <Image src={'/images/shape-1.svg'} alt="shape" width={200} height={200} className="absolute top-28 -left-8 -z-10" />
        ...
        <div className="container">
          ...
          <div className="flex gap-6 flex-wrap items-center justify-between">
            <div>
              ...
              <h2 className="title max-w-md">Advanced Dental Care for Healthier Smiles</h2>
            </div>
